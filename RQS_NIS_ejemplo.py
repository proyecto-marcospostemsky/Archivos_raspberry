...
print("   2. Energice el medidor y espere el mensaje de confirmacion. \n")
...
print("\nEnergice el medidor y espere el mensaje de confirmacion.")
...
while(1):
    ...
    if(rec_rec=="RQS NIS"):
        ...
        while(envio_OK==0):
            ...
            if "OK-"+NIS==rec_rec:
                print("\n\nSe configuro correctamente el NIS: "+NIS+".")
                envio_OK=1
    break
